...
@Serializable
object PhraseAuthScreenRoute

fun NavGraphBuilder.phraseAuth(
    onClose: () -> Unit,
    onDone: () -> Unit,
) = composable<PhraseAuthScreenRoute>(
    enterTransition = {
        slideIntoContainer(
    ...
    val route: PhraseAuthScreenRoute = entry.toRoute()
    val viewModel: PhraseAuthScreenViewModel = koinViewModel()
